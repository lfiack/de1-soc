...
# ----------------------------------------
# If pll_caca is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.1 917 linux 2023.10.09.16:27:20
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_caca.vho"
}
